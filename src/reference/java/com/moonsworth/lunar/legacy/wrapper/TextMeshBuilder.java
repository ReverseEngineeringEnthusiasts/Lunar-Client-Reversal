...
public class TextMeshBuilder {
   ...
   private static void method2(float var0, float var1, float var2, Bridge10$Data var3, boolean var4, FloatArrayList var5, int var6) {
      int var7 = var3.index();
      int var8 = var7 % 16 * 8;
      int var9 = var7 / 16 * 8;
   ...
   public static void method3(float var0, float var1, float var2, int var3, Bridge10$Data var4, boolean var5, FloatArrayList var6, int var7) {
   ...
   private static void method4(float var0, float var1, float var2, char var3, Bridge10$Data var4, boolean var5, FloatArrayList var6, int var7, boolean var8) {
      if (var3 != ' ' && var3 != 160) {
         if (var8) {
   ...
   public static List<Wrapper$Data3> method5(
      ...
      var6 = (var6 & 0xFF) << 24;
      String var9 = AdventureTextBridge.asLegacyString(var3);
      if (var8) {
         var9 = ThreadModuleDump86.getTextWithoutFormattingCodes(var9);
      }

      Bridge10$Data[] var10 = ThreadModuleDump63.method3().bridge$getFontRenderer().method20(var9);
      ...
      for (int var25 = var9.length(); var24 < var25; var24++) {
         ...
         if (var26 == 167 && var24 != var25 - 1) {
            ...
            Bridge10$Data var27 = var10[var24];
            float var28;
            if (!Bridge.method5().isPresent()) {
      ...
      if (var13 != null) {
         ...
         var41.add(new Wrapper$Data3(var42, var45, (ResourceLocationBridge)Minecraft.getMinecraft().fontRendererObj.locationFontTexture));
      }
      ...
      for (Entry var46 : var11.entrySet()) {
         ...
         var41.add(new Wrapper$Data3(var53, var54, (ResourceLocationBridge)var52));
      }
