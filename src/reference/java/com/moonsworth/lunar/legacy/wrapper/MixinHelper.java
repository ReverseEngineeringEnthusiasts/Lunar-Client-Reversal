...
public class MixinHelper implements MixinHelper_3 {
   @Override
   public void method1(Vector3iBridge var1, Vector3f[] var2) {
   ...
   public void method2(Vector3f var1, HorsestatsType_2 var2, int var3, float var4) {
      if (ThreadModuleDump63.MC_VERSION > 0 && ThreadModuleDump63.method3() != null) {
         ...
         HorsestatsType$Type var8 = var2.getAxis();
         ...
         for (int var13 = 0; var13 < 27.0F + var4 * 3.0F; var13++) {
            double var14 = (var10.nextFloat() - 0.5) * (var8 == HorsestatsType$Type.X ? 0.02 : 0.15 + var11);
            double var16 = (var10.nextFloat() - 0.5) * (var8 == HorsestatsType$Type.Y ? 0.02 : 0.15 + var11);
            double var18 = (var10.nextFloat() - 0.5) * (var8 == HorsestatsType$Type.Z ? 0.02 : 0.15 + var11);
            EntityFX var20 = var9.spawnEffectParticle(
               EnumParticleTypes.SNOW_SHOVEL.getParticleID(),
               var8 == HorsestatsType$Type.X ? var5 + var10.nextFloat() * 0.15 : var1.x() + 0.5 + var10.nextFloat() * var4 - var12,
               var8 == HorsestatsType$Type.Y ? var6 + var10.nextFloat() * 0.15 : var1.y() + 0.5 + var10.nextFloat() * var4 - var12,
               var8 == HorsestatsType$Type.Z ? var7 + var10.nextFloat() * 0.15 : var1.z() + 0.5 + var10.nextFloat() * var4 - var12,
               var14,
               var16,
               var18,
               new int[0]
            ...
            if (var20 != null) {
               ...
               var20.particleGreen = ThreadModuleDump23.greenFloat(var3);
