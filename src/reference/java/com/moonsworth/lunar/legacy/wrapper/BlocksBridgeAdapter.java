...
import com.moonsworth.lunar.bridge.Bridge3Extension_5;
...
public class BlocksBridgeAdapter implements Bridge_56 {
   ...
   public Bridge3Extension_5 method11() {
      return (Bridge3Extension_5)Blocks.stone_button;
   }
   ...
   public Bridge3_23 method57() {
      return ThreadModuleDump63.MC_VERSION >= 1 ? (Bridge3_23)Blocks.reeds : (Bridge3_23)Blocks.reeds;
   }

   public Bridge3_23 method58() {
      return ThreadModuleDump63.MC_VERSION >= 1 ? (Bridge3_23)Blocks.cactus : (Bridge3_23)Blocks.cactus$v1_7;
   }
   ...
   public Bridge3_23 method111(ResourceLocationBridge var1, int var2) {
      return ThreadModuleDump63.MC_VERSION >= 1
         ? (Bridge3_23)Block.blockRegistry.getObject((ResourceLocation)var1)
         : (Bridge3_23)Block.blockRegistry$v1_7.getObject(var1.toString());
   }

   public Bridge3_23 method112(String var1) {
      return this.method111(ResourceLocationBridge.create(var1), 0);
   }

   public List<Bridge3_23> method113() {
      return ThreadModuleDump63.MC_VERSION >= 1
         ? Block.blockRegistry.registryObjects.values().stream().map(var0 -> (Bridge3_23)var0).toList()
