...
public class HudRenderLegacyEventAlt extends Highlight {
   ...
   public static void method1(AbstractRenderContext var0, Bridge2_19 var1, float var2) {
      ClientEventBus.method29().method12(HudRenderLegacyEventAlt.class, () -> new HudRenderLegacyEventAlt(var0, var1, var2));
   }
   ...
   @Generated
   public HudRenderLegacyEventAlt(AbstractRenderContext var1, Bridge2_19 var2, float value) {
      this.field1 = var1;
      this.field2 = var2;
      this.field3 = value;
   }
