...
public class EventBlockBreakingProgress extends Highlight {
   private final int field1;
   private final Horsestats20Extension2 field2;
   private final int field3;

   @Generated
   public EventBlockBreakingProgress(int value, Horsestats20Extension2 horsestats20Extension2, int value2) {
      this.field1 = value;
