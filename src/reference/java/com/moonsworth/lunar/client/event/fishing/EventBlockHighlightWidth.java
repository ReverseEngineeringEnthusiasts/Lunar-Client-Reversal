...
public class EventBlockHighlightWidth extends EventBlockHighlight {
   private float field5;

   public EventBlockHighlightWidth(GameRendererBridge bridge3_171, BridgeExtension bridge, Bridge3_23 bridge3_233, double value, float value2) {
