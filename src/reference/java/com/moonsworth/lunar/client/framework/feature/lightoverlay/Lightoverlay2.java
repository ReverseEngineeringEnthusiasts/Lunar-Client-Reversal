...
class Lightoverlay2 {
   ...
   public void method2(LightOverlay var1, Itemcounter6Extension var2) {
      ...
      int var8 = 0;
      com.moonsworth.lunar.bridge.horsestats.Vector3iBridge.Extension var9 = null;
      ...
      for (int var10 = 0; var10 < var4.length; var10++) {
         ...
         if (var12 == null) {
            ...
            for (int var18 = 0; var18 < 4096; var18++) {
               ...
               if (var1.canMonstersSpawn((Horsestats20Extension2)var9, var22)) {
   ...
   public void method4(AbstractRenderContext var1, Bridge2_43 var2, LightOverlay var3) {
      ...
      if (var5 != 0) {
         ...
         LightOverlay.Type var11 = var3.lightOverlayMode.get();
         LightoverlayHandler2 var12 = null;
         if (var11 == LightOverlay.Type.CROSS) {
            var12 = new LightoverlayHandler(var1, var3);
         } else if (var11 == LightOverlay.Type.OVERLAY) {
