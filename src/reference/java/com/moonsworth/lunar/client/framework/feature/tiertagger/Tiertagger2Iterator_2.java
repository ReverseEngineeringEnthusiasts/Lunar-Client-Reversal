...
public class Tiertagger2Iterator_2 extends Tiertagger2Iterator_3 {
   private static final Tiertagger2$Data field4 = new Tiertagger2$Data(
      ServiceEndpoints.method4() + "/tier-tagger/pvptiers/", RCCHRICRRRHICROHRHOIICCOHORORC, true, true
   );
   ...
   protected List<Tiertagger_2> method4() {
      return Tiertagger6Impl.method3().method5();
   }
