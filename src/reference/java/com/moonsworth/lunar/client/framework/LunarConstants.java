...
import com.moonsworth.lunar.client.framework.feature.tps.TpsDeserializer;
import com.moonsworth.lunar.client.framework.feature.tps.Tps;
import com.moonsworth.lunar.client.framework.crash.ThrowableJsonSerializer;
import com.moonsworth.lunar.client.util.io.JsonDateAdapter;
...
public class LunarConstants {
   ...
   public static final String field3 = CollectionUtils.firstNonNull(System.getenv("PROCESSOR_ARCHITECTURE"), System.getProperty("os.arch"));
   ...
   public static final Gson field22 = new GsonBuilder()
      .registerTypeAdapter(CrashReportBridge.class, new ThrowableJsonSerializer())
      .registerTypeAdapter(Tps.class, new TpsDeserializer())
      .registerTypeAdapter(LocalDate.class, new JsonDateAdapter())
      .registerTypeAdapterFactory(new NotNullSerialized.Data())
      .create();
   ...
   static {
      Path path0 = field6.resolve("settings");
      field25 = path0.resolve("game").toFile();
      field26 = path0.resolve("game-backup").toFile();
   }
}
