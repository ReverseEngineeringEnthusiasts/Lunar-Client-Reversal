...
public class LogIconMapping extends SuffixIconMapping {
   public LogIconMapping() {
   }
   ...
   public boolean method4(@NotNull ItemStackBridge bridgeextension_41) {
      ...
      return text2.startsWith("minecraft:") && text2.endsWith("_log") || text2.equals("minecraft:log") || text2.equals("minecraft:log2");
   }
   ...
   protected String method1(int number1, ItemStackBridge bridgeextension_42) {
      ...
      if (bridgeextension_42.bridge$getItemRegistryName().endsWith("log2")) {
         number3 += 4;
      }
