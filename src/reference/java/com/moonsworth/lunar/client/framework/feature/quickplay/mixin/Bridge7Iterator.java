...
public class Bridge7Iterator extends com.moonsworth.lunar.client.ui.LcuiScreen {
   ...
   public Bridge7Iterator(Bridge5Extension6 var1, Quickplay var2) {
      this.field19 = var1;
      this.field20 = var2;
      com.moonsworth.lunar.client.mod.misc.quickplay.Quickplay var3 = Client.method109().method40().method52();
      ModifierKeybindOption var4 = var3.method6(this.field20);
      ToggleOption var5 = (ToggleOption)((ToggleOptionBuilder)OptionFactory.method7("favorite")
            .method4(var3.method16().contains(var2.getKey())))
         .method31();
      this.field21.setTitle(var2.getName() + " Options");
      this.field21.method8(-1090519040);
      this.field21
         .method14(
            ImmutableList.of(
               this.field22 = new TextLabelWidget(this.field21, "done"),
               this.field23 = (KeybindToggleWidget)var4.method18(this.field21),
               this.field24 = (HoverInfoOptionWidget)var5.method18(this.field21)
            )
         );
      this.field22.method25((var1x, var2x) -> {
         Bridge7_8 var3x = ThreadModuleDump63.method31(var1);
         if (var3x instanceof Bridge7Iterator2) {
      ...
      var5.CICORRHIOIIOORRRICCORIOIOCIHII(
         var4x -> {
            if (var4x) {
               var3.method16().add(var2.getKey());
            } else {
               var3.method16().remove(var2.getKey());
               Bridge7_8 var5x = ThreadModuleDump63.method31(var1);
               if (var5x instanceof Bridge7Iterator2) {
                  ((Bridge7Iterator2)var5x)
   ...
   protected List<GuiWidget> method25() {
      return ImmutableList.of(this.field21 = new TitledWidget(null, "") {
         public void method3(float var1, float var2, float var3, float var4) {
            Bridge7Iterator.this.field22.method2(var1 + var3 - 45.0F, var2 + var4 - 23.0F, 40.0F, 15.0F);
            Bridge7Iterator.this.field23.RIIICIRHRCIHOOOORHOICRIICCCRHR(var1 + 8.0F, var2 + 30.0F, this.width - 16.0F, 26.0F);
            Bridge7Iterator.this.field24.RIIICIRHRCIHOOOORHOICRIICCCRHR(var1 + 8.0F, var2 + 45.0F, this.width - 16.0F, 26.0F);
         }
      });
   }
   ...
   public void init() {
      ...
      float var1 = 98.0F;
      float var2 = 200.0F;
      this.field21.method2(this.method22() / 2.0F - var2 / 2.0F, this.method23() / 2.0F - var1 / 2.0F, var2, var1);
   }
