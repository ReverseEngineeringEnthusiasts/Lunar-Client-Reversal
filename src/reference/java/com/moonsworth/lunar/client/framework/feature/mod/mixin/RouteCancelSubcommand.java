...
public class RouteCancelSubcommand implements RouteSubcommand {
   public RouteCancelSubcommand() {
   }

   @Override
   public void method1(String[] items1) {
      RouteManager holograms3_32 = SkyblockDungeonRoutes.method13().method16();
      if (!holograms3_32.method27().method10()) {
         TextComponent text4 = TextBridge.asAdventure(MixinHelper.method1("notCurrentlyRecording", ChatFormatting.AQUA, ChatFormatting.RED));
         Ref.method7().HRICOROOOCCOCOROCRHHCRRIRCOICO(text4);
      } else {
         holograms3_32.method27().method1();
         holograms3_32.method15();
         TextComponent text3 = TextBridge.asAdventure(MixinHelper.method1("recordingCancelled", ChatFormatting.AQUA, ChatFormatting.YELLOW));
