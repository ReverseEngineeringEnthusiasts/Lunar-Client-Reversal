...
public class EntityIconRegistry extends IconRegistry<EntityIconRegistry.Data, BridgeExtension> {
   public EntityIconRegistry() {
   }
   ...
   protected void initMappings() {
      ...
      this.method2(new BoatIconMapping());
      this.method2(new HorseIconMapping());
   }

   public boolean method1(@NotNull BridgeExtension bridgeextension1) {
      return Ref.MC_VERSION > 5 ? bridgeextension1.bridge$getEntityString().startsWith("minecraft:") : true;
   }
   ...
   public Optional<Markers3_2> method3(@NotNull BridgeExtension bridgeextension1) {
      String text2 = bridgeextension1.bridge$getEntityString();
      return text2 != null && !text2.trim().isEmpty() ? Optional.of(new Markers3_2(text2, method5(bridgeextension1))) : Optional.empty();
   }

   public Optional<EntityIconRegistry.Data> method4(@NotNull Markers3_2 markers3_21) {
      return EntityIconRegistry.Data.method1(markers3_21);
   }

   public static Markers2_3 method5(@NotNull BridgeExtension bridgeextension0) {
      Markers2_3 markers2_31 = Markers2_3.method2();
      Component component2 = bridgeextension0.bridge$getCustomName();
      if (component2 != null) {
         markers2_31 = Markers2_3.method3(LegacyComponentSerializer.legacySection().serialize(component2));
      }
   ...
   public class Data {
      ...
      public Data(String text1, @Nullable Component component2) {
         this.field1 = text1;
         this.field2 = component2;
      }

      public static Optional<EntityIconRegistry.Data> method1(Markers3_2 markers3_20) {
         String text1 = markers3_20.value();
         TextComponent text2 = null;
         if (!markers3_20.method1().isEmpty()) {
            text2 = LegacyComponentSerializer.legacySection().deserialize(markers3_20.method1().value());
         }

         return Optional.of(new EntityIconRegistry.Data(text1, text2));
      }
