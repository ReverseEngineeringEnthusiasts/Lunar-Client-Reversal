...
import com.moonsworth.lunar.client.framework.feature.tiertagger.Tiertagger2Iterator_3;
...
public class Tiertagger2Iterator extends Tiertagger2Iterator_3 {
   private static final Tiertagger2$Data field4 = new Tiertagger2$Data(
      ServiceEndpoints.method4() + "/tier-tagger/subtiers/", RCCHRICRRRHICROHRHOIICCOHORORC, true, true
   );
