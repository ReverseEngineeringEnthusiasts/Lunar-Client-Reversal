...
public enum MapRoomType {
   ...
   public static MapRoomType fromProto(DungeonRoomType dungeonroomtype0) {
      return switch (dungeonroomtype0) {
   ...
   @Generated
   MapRoomType(boolean flag3, NamedTextColor namedtextcolor4) {
      this.hasSecrets = flag3;
