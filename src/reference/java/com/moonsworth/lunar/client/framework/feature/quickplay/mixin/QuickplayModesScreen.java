...
public class QuickplayModesScreen extends com.moonsworth.lunar.client.ui.LcuiScreen {
   private final Quickplay field19;
   private final ResourceLocationBridge field20;

   public QuickplayModesScreen(Bridge7_8 bridge7_81, Quickplay quickplay2, @NotNull ResourceLocationBridge horsestats143) {
      this.field19 = quickplay2;
      this.field20 = horsestats143;
      this.field11
         .add(new QuickplayModeEntry(bridge7_81, null, null, "", "< " + this.method105("returnMenu", new Object[0])));
      if (!(bridge7_81 instanceof QuickplayModesScreen)) {
         this.field11
            .add(new QuickplayModeEntry(bridge7_81, null, this.field19, "/l " + quickplay2.getKey(), this.method105("lobby", new Object[0])));
      }

      for (Quickplay quickplay5 : this.field19.method4()) {
         if (!quickplay5.isDisabled()) {
            this.field11.add(new QuickplayModeEntry(this, this.field19, quickplay5, quickplay5.method2(), quickplay5.getName()));
         }
      }
   }
   ...
   public void init() {
      ...
      for (GuiWidget calculator2handler9 : this.field11) {
         if (calculator2handler9 instanceof QuickplayModeEntry) {
   ...
   public void method10(MixinHelper_4 mixinhelper_41, Data2 data22) {
      ...
      FontRegistry.method22().method15(mixinhelper_41, this.field19.getName(), value3, value4 - 10.0F, -1);
      FontRegistry.method16().method15(mixinhelper_41, this.method105("chooseGame", new Object[0]), value3, value4 + 15.0F, -1);
