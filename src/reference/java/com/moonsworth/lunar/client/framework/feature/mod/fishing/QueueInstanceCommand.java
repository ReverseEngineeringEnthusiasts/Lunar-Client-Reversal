...
public class QueueInstanceCommand extends SkyBlockChatCommand {
   public QueueInstanceCommand() {
   }
   ...
   public void method6(String text, String text2, String[] items3, FishingChatType fishingChatType) {
      String text5 = text.equals(this.getCommand()) && items3.length >= 1 ? items3[0] : text;

      String text6 = switch (text5) {
      ...
      if (text6 != null) {
         this.method7("/joininstance " + text6);
      }
   }
}
