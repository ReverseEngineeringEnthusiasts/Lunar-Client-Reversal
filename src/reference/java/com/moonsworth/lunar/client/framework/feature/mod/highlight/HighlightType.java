...
public enum HighlightType {
   ...
   private final Vector3iBridge bossRoomPos;
   private final String prettyName;

   private static Vector3iBridge pos(int var0, int var1, int var2) {
      return Bridge.method8().method4(var0, var1, var2);
   }
   ...
   @Generated
   public Vector3iBridge getBossRoomPos() {
   ...
   @Generated
   HighlightType(int var3, float var4, int var5, Vector3iBridge var6, String var7) {
      this.number = var3;
