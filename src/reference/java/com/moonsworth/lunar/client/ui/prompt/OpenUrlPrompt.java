...
public class OpenUrlPrompt extends PromptAction {
   ...
   public void method1(boolean flag1) {
      ...
      if (flag1 && text2 != null) {
         Ref.method4().method41().method6().method88().add(text2);
      }
   }
   ...
   public Component method2() {
      ...
      return Component.text(foghandler281.method2("gui.apollo.button.openUrlPrompt", "saveChoice", new Object[]{this.field1}));
   }
   ...
   public Component method3() {
      TranslationManager foghandler281 = Ref.method4().method67();
      return Component.text(foghandler281.method2("gui.apollo.button.openUrlPrompt", "saveChoiceAll", new Object[0]));
   }

   @Generated
   public OpenUrlPrompt(String text) {
      this.field1 = text;
   }
}
