...
public abstract class MixinCore5Handler2 implements MixinCore5 {
   protected MixinCore5 field1;

   public MixinCore5Handler2() {
   }

   public MixinCore5Handler2(MixinCore5 var1) {
      this.field1 = var1;
   }
