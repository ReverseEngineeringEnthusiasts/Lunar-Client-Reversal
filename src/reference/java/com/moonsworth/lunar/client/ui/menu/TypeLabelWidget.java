...
public class TypeLabelWidget extends EditableLabelWidget {
   private final Calculator2Type field18;

   public TypeLabelWidget(Calculator2Type var1, GuiWidget var2) {
      super(var2, var1.toString().toUpperCase());
      this.field18 = var1;
      this.field17 = new AnimatedValue(-2142268164, -11561732);
   ...
   public void method3(MixinHelper_4 var1, MarkerModel.Data2 var2, boolean var3) {
      ...
      String var5 = this.method1(this.field18.toString(), new Object[0]).toUpperCase().replace("", " ").trim();
      this.field16
   ...
   @Generated
   public Calculator2Type method3() {
      return this.field18;
   }
}
