...
public class MultiSelectWidget
   ...
   private final @Nullable Function<String, @Nullable String> field24;
   private final Consumer<List<String>> field25;

   public MultiSelectWidget(ListOption<String> var1, GuiWidget var2) {
      this(var1, var2, 12.0F, true);
   }

   public MultiSelectWidget(ListOption<String> var1, GuiWidget var2, float var3) {
      this(var1, var2, var3, true);
   }

   public MultiSelectWidget(ListOption<String> var1, GuiWidget var2, float var3, boolean var4) {
      this(var1, var2, var3, var4, null);
   }

   public MultiSelectWidget(
      ListOption<String> var1, GuiWidget var2, float var3, boolean var4, @Nullable Function<String, @Nullable String> var5
   ) {
      super(var1, var2);
      this.field19 = var3;
      this.field23 = var4;
      ...
      this.field21 = new IconTextButton(this, this.getIcon(), FontRegistry.method17(), var1.getName(), 544831865, 1081702777);
      this.field20 = new CopyOnWriteArrayList<>();
      this.field25 = var1x -> this.method1(null);
      this.option.CICORRHIOIIOORRRICCORIOIOCIHII(this.field25);
      this.field21.method41(() -> {
         String var2x = this.field21.getText();
         if (!var2x.trim().isEmpty()) {
            String var3x = this.field23 ? var2x.toLowerCase() : var2x;
            if (this.field24 != null) {
               var3x = this.field24.apply(var3x);
               if (var3x == null) {
                  return;
               }
            }
      ...
      this.field21.field34 = () -> this.method1(this.field21.getText());
   }
   ...
   public void method2(float var1, float var2, float var3, float var4) {
      ...
      this.field21.method2(var1, var2 + 2.0F, var3, 13.0F);
      this.field22.method2(var1 + var3 - 4.0F, var2 + 17.0F, 4.0F, var4 - 17.0F);
      int var5 = 0;
   ...
   public void method3(MixinHelper_4 var1, MarkerModel.Data2 var2, boolean var3) {
      ...
      this.field22.method15(this.field19 * this.field20.size());
      this.field22.method5(var1, var2, var3);
      MarkerModel.Data2 var4 = this.field22.method4(var2);

      for (GuiWidget var6 : this.field20) {
         boolean var7 = var6.getY() + var6.getHeight() + this.field22.method3() < this.field22.getY();
         boolean var8 = var6.getY() + this.field22.method3() > this.y + this.height;
         if (!var7 && !var8) {
            var6.method3(var1, var4, true);
         }
      }

      this.field22.method7(var1, var2, var3 && var2.method9() > this.x + this.width - 4.0F);
   ...
   public boolean method6(MarkerModel.Data2 var1, int var2) {
      if (this.field21.method3(var1)) {
         return this.field21.method6(var1, var2);
      }

      this.field21.method4(' ', KeyCode.KEY_RETURN);
      this.field21.method17(false);
      ...
      if (this.field21.method18()) {
         if (var2 == KeyCode.KEY_BACK) {
            if (this.field21.getText().length() > 0) {
               this.field21.setText(this.field21.getText().substring(0, this.field21.getText().length() - 1));
            }
