...
public class SettingKeysMixin<T> implements Highlight {
   @Final
   @Shadow
   ...
   public SettingKeysMixin() {
   }

   public ClientOption getOption() {
      if (this.option == null) {
         if (Ref.method4() != null && Ref.method4().method40() != null) {
            OptionContainer framework51 = (OptionContainer)Ref.method4().method40().method64().method7(ModTraits.field14);
   ...
   private ClientOption createOption(boolean flag1) {
      ClientOption lightingextension2 = this.method1(this.defaultValue, this.key);
      if (flag1) {
