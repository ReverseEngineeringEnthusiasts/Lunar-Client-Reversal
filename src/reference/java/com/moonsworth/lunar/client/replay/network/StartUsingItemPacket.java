...
public class StartUsingItemPacket extends ReplayPacket {
   private int field1;
   ...
   public void method3(ReplayContext nameplate41) {
      ...
      if (bridge5extension_52 != null) {
         bridge5extension_52.bridge$startUsingItem(this.field1);
      }
   }

   @Generated
   public StartUsingItemPacket(int value) {
      this.field1 = value;
   }

   @Generated
   public StartUsingItemPacket() {
   }
}
