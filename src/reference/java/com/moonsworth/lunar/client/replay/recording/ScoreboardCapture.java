...
public class ScoreboardCapture implements RecorderCapture {
   public ScoreboardCapture() {
   }
   ...
   public void method1(@NonNull RewindRecorder rewindhandlers51, @NonNull Bridge5Extension_5 bridge5extension_52, @NonNull Itemcounter6 itemcounter63) {
      ...
      for (PacketBridge bridge3_216 : bridge_164.method22().method2()) {
         rewindhandlers51.method3(ClientboundPacketEventFactory.method2(bridge3_216));
      }

      for (PacketBridge bridge3_218 : itemcounter63.bridge$getScoreboardPackets()) {
         rewindhandlers51.method3(ClientboundPacketEventFactory.method2(bridge3_218));
      }

      rewindhandlers51.method3(ClientboundPacketEventFactory.method2(bridge_164.method27().method1(Ref.method3().bridge$getGuiIngame())));
   }
}
