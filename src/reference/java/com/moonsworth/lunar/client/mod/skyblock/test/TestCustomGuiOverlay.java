...
import com.moonsworth.lunar.client.framework.feature.mod.debug.testcustomguioverlay.TestOverlayModule;
import com.moonsworth.lunar.client.framework.Ref;
import com.moonsworth.lunar.client.mod.skyblock.core.Skyblock;

public class TestCustomGuiOverlay extends AbstractFeature {
   private final GuiModuleManager field8 = (GuiModuleManager)this.method63(GuiModuleManager.class);

   public TestCustomGuiOverlay(Skyblock skyblock1) {
      super(false);
      this.method45(ModTraits.field16, ChildModBinding.method3(skyblock1));
      if (Ref.MC_VERSION >= 1) {
         this.field8
            .method3(new TestOverlayModule(), (ModLifecycle)this.method14(ModTraits.field12, arg0 -> ModLifecycle.method13()));
      }
   }

   public String getId() {
      return "TEST_CUSTOM_GUI_OVERLAY";
   }
