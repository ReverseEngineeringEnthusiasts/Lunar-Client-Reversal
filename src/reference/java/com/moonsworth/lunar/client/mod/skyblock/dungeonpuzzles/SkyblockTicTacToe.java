...
public class SkyblockTicTacToe extends AbstractFeature {
   ...
   public SkyblockTicTacToe(SkyblockDungeonPuzzles var1, ToggleOption var2) {
      super(true);
      this.method9(Framework.field16, Framework4.method4(false, var1));
      this.method9(Framework.field6, ModEnabledState.method7(var2));
      this.method6(this::method13);
      this.handle(Rewindhandlers$Data10.class, var1x -> this.method13());
      this.handle(EntitySpawnEvent.class, var1x -> this.method5(var1x.field1));
      this.handle(HudRenderLegacyEvent.class, this::method7);
      this.handle(EventEntityRemoval.class, this::method6);
   }
   ...
   public void method3(Holograms4Iterator var1) {
      this.field12 = new SkyblockTicTacToe.Data(var1.method23().get().method4(this.field11), var1.method23().get().method28());
      ...
      var2.ifPresent(var2x -> {
         ...
         if (var3 == SkyblockTicTacToe.Type.O) {
            this.field13 = var1.method23().get().method4(new Vector3i(this.field11).add(0, (Integer)var2x.second(), -(Integer)var2x.first()));
         } else {
            this.field13 = null;
         }
      });
   ...
   private void method5(BridgeExtension var1) {
      if (Click3.getIsland() == Gui2Extension3.DUNGEON) {
         if (var1 instanceof ItemFrameEntityBridge var2) {
            if (var2.bridge$getItemStack().bridge$getItem() instanceof Bridge5_4 var3) {
               ...
               if (var13 != null) {
                  ...
                  if (var5.length == 16384) {
                     byte var6 = var5[8256];
                     Vector3iBridge var7 = var2.bridge$getHangingPosition();
   ...
   private void method6(EventEntityRemoval var1) {
      if (Click3.getIsland() == Gui2Extension3.DUNGEON) {
         if (var1.method1() instanceof ItemFrameEntityBridge var2) {
            ItemStackBridge var6 = var2.bridge$getItemStack();
            if (var6 != null) {
               if (var6.bridge$getItem() instanceof Bridge5_4) {
                  Vector3iBridge var4 = var2.bridge$getHangingPosition();
   ...
   private void method7(HudRenderLegacyEvent var1) {
      ...
      if (var3 != null && var3.method25() == HologramsType8.TIC_TAC_TOE) {
         if (this.field12 != null && this.field13 != null) {
            ...
            Click.drawBlockOutline(var5, this.field13, 570490624);
            var5.pop();
         }
      }
   }
