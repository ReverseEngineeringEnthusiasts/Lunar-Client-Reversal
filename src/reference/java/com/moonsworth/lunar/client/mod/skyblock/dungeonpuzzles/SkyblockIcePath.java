...
public class SkyblockIcePath extends AbstractFeature {
   ...
   public SkyblockIcePath(SkyblockDungeonPuzzles var1, ToggleOption var2) {
      super(true);
      this.method12(Framework.field16, Framework4.method4(false, var1));
      this.method12(Framework.field6, ModEnabledState.method7(var2));
      this.method3(this::method13);
      this.handle(Rewindhandlers$Data10.class, var1x -> this.method13());
      this.handle(EntitySpawnEvent.class, this::method6);
      this.handle(EventClientTick.class, var1x -> this.method14());
   ...
   public void method3(Holograms4Iterator var1) {
      this.field11 = null;
      this.field10 = var1.method23().get().method4(new Vector3i(14, 67, 28));
      this.method9(var1);
   ...
   private void method6(EntitySpawnEvent var1) {
      SkyblockDungeonPuzzles var2 = ((Framework4)this.method7(Framework.field16)).method1();
   ...
   private boolean method7(BridgeExtension var1) {
      ...
      if (var1 instanceof ItemEntityBridge var4) {
   ...
   private void method9(Holograms4Iterator var1) {
      ...
      if (var2 != null) {
         ...
         Holograms3 var4 = var1.method23().get();

         for (int var5 = 6; var5 <= 24; var5++) {
            for (int var6 = 7; var6 <= 28; var6++) {
               Vector3iBridge var7 = var4.method1(Bridge.method8().method4(var5, 67, var6));
   ...
   private void method16(com.moonsworth.lunar.client.event.mixin.nameplate.HudRenderLegacyEvent var1) {
      SkyblockDungeonPuzzles var2 = ((Framework4)this.method7(Framework.field16)).method1();
      Holograms4Iterator var3 = var2.method47();
      if (var3 != null && var3.method25() == HologramsType8.ICE_PATH) {
         if (!this.field9.isEmpty()) {
            ...
            Bridge_28 var6 = var4.method11(var2.method42().get());
            var6.method1(-65536);
