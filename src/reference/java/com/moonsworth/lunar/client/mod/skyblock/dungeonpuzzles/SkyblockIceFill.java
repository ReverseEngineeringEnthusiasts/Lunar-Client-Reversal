...
public class SkyblockIceFill extends AbstractFeature {
   ...
   public SkyblockIceFill(SkyblockDungeonPuzzles var1, ToggleOption var2) {
      super(true);
      this.method6(Framework.field16, Framework4.method4(false, var1));
      this.method6(Framework.field6, ModEnabledState.method7(var2));
      ...
      this.handle(HudRenderLegacyEvent.class, this::method9);
   }
   ...
   private void method9(HudRenderLegacyEvent var1) {
      SkyblockDungeonPuzzles var2 = ((Framework4)this.method7(Framework.field16)).method1();
      Holograms4Iterator var3 = var2.method47();
      if (var3 != null && var3.method25() == HologramsType8.ICE_FILL) {
         if (!this.field8.isEmpty() && !this.field9.isEmpty() && !this.field10.isEmpty()) {
            ...
            Bridge_28 var6 = var4.method11(var2.method40().get());
            var6.method1(-65536);
