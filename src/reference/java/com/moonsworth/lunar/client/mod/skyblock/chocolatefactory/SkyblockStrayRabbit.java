...
public class SkyblockStrayRabbit extends AbstractFeature {
   ...
   private final ObjectOpenHashSet<SlotBridge> field10 = new ObjectOpenHashSet();

   public SkyblockStrayRabbit(SkyblockChocolateFactory skyblockchocolatefactory1, ToggleOption lightingextension4432) {
      super(true);
      ...
      this.handle(EventScreenInitPre.class, arg1x -> this.field10.clear());
   }
   ...
   private void method2(EventRenderHologramItem data51) {
      if (this.field8.method7() == SkyblockMenuType.CHOCOLATE_FACTORY) {
         if (this.field10.contains(data51.method3())) {
            ...
            data51.method1(skyblockchocolatefactory2.method49().method14(0.0F));
      ...
      if (this.field8.method7() == SkyblockMenuType.CHOCOLATE_FACTORY) {
         ...
         if (index2 >= 0 && index2 < 54) {
            ...
            if (bridgeextension_44 != null && !bridgeextension_44.bridge$isEmpty()) {
               if (bridgeextension_44.bridge$getDisplayName().endsWith("CLICK ME!")) {
                  this.field10.add(bridge3_183);
               } else {
                  this.field10.remove(bridge3_183);
               }
            }
         }
      }
