...
public class SkyblockQuiz extends AbstractFeature {
   ...
   public SkyblockQuiz(SkyblockDungeonPuzzles var1, ToggleOption var2) {
      super(true);
      this.method3(Framework.field16, Framework4.method4(false, var1));
      this.method3(Framework.field6, ModEnabledState.method7(var2));
      this.method4(this::clear);
      this.handle(EventWorldChanged.class, var1x -> this.clear());
                        ...
                        for (Holograms8_2 var6 : var4.method6()) {
                           ...
                           if (var7.matches()) {
                              ...
                              if (var6.method4() != -1) {
                                 ...
                                 this.field9.add(var6.method3().get(var8));
                              } else {
   ...
   private boolean method6(Data var1, String var2) {
      if (var2.charAt(0) == 9424 || var2.charAt(0) == 9425 || var2.charAt(0) == 9426) {
         ...
         if (this.field9.contains(var2)) {
            this.field11 = var3;
            SkyblockDungeonPuzzles var4 = ((Framework4)this.method7(Framework.field16)).method1();
   ...
   private void method7(HudRenderLegacyEvent var1) {
      ...
      if (var3 != null && var3.method25() == HologramsType8.QUIZ) {
         if (this.field10 != null) {
            ...
            Click.drawBlockOutline(var4, this.field10);
            var4.pop();
         }
      }
   }
   ...
   private Vector3i method9(Holograms4Iterator var1) {
      return var1.method23().get().method1(Bridge.method8().method4(20, 70, 6)).bridge$toJoml();
   }

   private Vector3i method10(Holograms4Iterator var1) {
      return var1.method23().get().method1(Bridge.method8().method4(15, 70, 9)).bridge$toJoml();
   }

   private Vector3i method11(Holograms4Iterator var1) {
      return var1.method23().get().method1(Bridge.method8().method4(10, 70, 6)).bridge$toJoml();
   }
}
