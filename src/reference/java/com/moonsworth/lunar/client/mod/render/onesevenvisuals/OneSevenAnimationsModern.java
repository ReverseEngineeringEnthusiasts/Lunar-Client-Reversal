...
@VersionGate(min = 5)
public class OneSevenAnimationsModern extends AbstractFeature {
   ...
   public OneSevenAnimationsModern(OneSevenVisuals onesevenvisuals1) {
      super(false);
   ...
   public void method2(RootSettingsBuilder lightingextension231) {
      ...
      ((SettingsSectionImpl)lightingextension231.method14())
         .method2(() -> !Ref.method4().method40().method26().isEnabled())
         .OHHOOIIHIRCCCRCRRRCIICIHOOIRRH();
      lightingextension231.method9(new ClientOption[]{this.hurtCameraShake, this.healthAnimation});
      ...
      ((SettingsSectionImpl)((SettingsSectionImpl)lightingextension231.method9(new ClientOption[]{this.sneakEyeHeight}))
   ...
   public boolean method14() {
      return this.isEnabled() && (Boolean)this.glintAnimation.get();
   }

   public boolean isHurtCameraShakeEnabled() {
