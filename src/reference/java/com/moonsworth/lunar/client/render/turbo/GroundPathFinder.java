...
public class GroundPathFinder extends PathFinder {
   private final Object2BooleanMap<AxisAlignedBBBridge> field9 = new Object2BooleanOpenHashMap();
   private final Long2ObjectMap<ItemcounterType2_3> field10 = new Long2ObjectOpenHashMap();
   private final com.moonsworth.lunar.client.render.turbo.PathNode[] field11 = new com.moonsworth.lunar.client.render.turbo.PathNode[HorsestatsType$Type3.HORIZONTAL
      .size()];

   public void method1(Itemcounter6Extension var1, com.moonsworth.lunar.client.render.turbo.PathEntity var2) {
   ...
   @NotNull
   @Override
   public ScoredPathNode method5(int var1, int var2, int var3) {
      return new ScoredPathNode(this.method3(var1, var2, var3));
   }

   @Override
   public com.moonsworth.lunar.client.render.turbo.PathNode method6() {
      Vector3iBridge.Extension var1 = Bridge.method8().method9(0, 0, 0);
      Horsestats20Extension2 var2 = this.field1.method8();
      int var3;
      int var4;
      int var5;
      if (var2 == null) {
         var3 = (int)Math.floor(this.field1.bridge$getPosX());
         var4 = (int)Math.floor(this.field1.bridge$getPosY());
         var5 = (int)Math.floor(this.field1.bridge$getPosZ());
      } else {
      ...
      var1.method1(this.field1.bridge$getPosX(), var4, this.field1.bridge$getPosZ());
      Bridge2_17 var6 = this.field8.method1(var1);
      if (this.field6 && this.field1.isInWater()) {
         while (var6.bridge$getBlock().bridge$isWater()) {
            var1.method1(this.field1.bridge$getPosX(), ++var4, this.field1.bridge$getPosZ());
            var6 = this.field8.method1(var1);
         }

         var4--;
      } else if (this.field1.isOnGround()) {
         var4 = (int)Math.floor(this.field1.bridge$getPosY() + 0.5);
      } else {
         var1.method1(
            this.field1.bridge$getPosX(),
            this.field1.bridge$getPosY() + 1.0,
            this.field1.bridge$getPosZ()
         );

         while (var1.bridge$getY() > this.field8.method2().bridge$getMinBuildHeight()) {
            var4 = var1.bridge$getY();
            var1.bridge$setPos(var1.bridge$getX(), var1.bridge$getY() - 1, var1.bridge$getZ());
            Bridge2_17 var7 = this.field8.method1(var1);
            if (!var7.bridge$getBlock().bridge$isAir()
               && !var7.bridge$isPathfindable(this.field8.method2(), var1, ItemcounterType_3.LAND)) {
               break;
            }
         }
      }
      ...
      if (!this.method16(var1)) {
         AxisAlignedBBBridge var8 = this.field1.method7();
   ...
   public int method7(com.moonsworth.lunar.client.render.turbo.PathNode[] var1, com.moonsworth.lunar.client.render.turbo.PathNode var2) {
      ...
      if (this.field1.method2(var5) >= 0.0F && var6 != ItemcounterType2_3.STICKY_HONEY) {
         var4 = (int)Math.floor(Math.max(1.0F, this.field1.method3()));
      }

      double var7 = this.method9(Bridge.method8().method4(var2.x, var2.y, var2.z));

      for (HorsestatsType_2 var10 : HorsestatsType$Type3.HORIZONTAL) {
         com.moonsworth.lunar.client.render.turbo.PathNode var11 = this.method11(
      ...
      for (HorsestatsType_2 var14 : HorsestatsType$Type3.HORIZONTAL) {
         ...
         if (this.method18(var2, this.field11[var14.getHorizontal()], this.field11[var15.getHorizontal()])) {
            com.moonsworth.lunar.client.render.turbo.PathNode var12 = this.method11(
   ...
   public boolean method5(
      @Nullable com.moonsworth.lunar.client.render.turbo.PathNode var1, com.moonsworth.lunar.client.render.turbo.PathNode var2
   ) {
      return var1 != null && !var1.closed && (var1.field7 >= 0.0F || var2.field7 < 0.0F);
   }

   public boolean method6(com.moonsworth.lunar.client.render.turbo.PathNode var1) {
      AxisAlignedBBBridge var2 = this.field1.method7();
      Vec3Bridge var3 = Vec3Bridge.method2(
         var1.x - this.field1.bridge$getPosX() + var2.method14() / 2.0,
         var1.y - this.field1.bridge$getPosY() + var2.method15() / 2.0,
         var1.z - this.field1.bridge$getPosZ() + var2.method16() / 2.0
      );
   ...
   public static double method7(Itemcounter6 var0, Vector3iBridge var1) {
      Vector3iBridge var2 = var1.bridge$below();
   ...
   public boolean method8(AxisAlignedBBBridge var1) {
      return this.field9.computeIfAbsent(var1, var1x -> !this.field8.method2().bridge$noCollision(null, (AxisAlignedBBBridge)var1x));
   }

   public double method9(Vector3iBridge var1) {
      Itemcounter6 var2 = this.field8.method2();
      return (this.field6 || this.method10()) && var2.method4(var1).bridge$isWater() ? var1.bridge$getY() + 0.5 : method7(var2, var1);
   }
   ...
   @Nullable
   public com.moonsworth.lunar.client.render.turbo.PathNode method11(
      int var1, int var2, int var3, int var4, double var5, HorsestatsType_2 var7, ItemcounterType2_3 var8
   ) {
      com.moonsworth.lunar.client.render.turbo.PathNode var9 = null;
      Vector3iBridge.Extension var10 = Bridge.method8().method9(var1, var2, var3);
      ...
      float var14 = this.field1.method2(var13);
      if (var14 >= 0.0F) {
      ...
      if (var13 != ItemcounterType2_3.WALKABLE && (!this.method10() || var13 != ItemcounterType2_3.WATER)) {
         if ((var9 == null || var9.field7 < 0.0F)
            && var4 > 0
            && (var13 != ItemcounterType2_3.FENCE || this.method10())
         ...
         } else if (!this.method10() && var13 == ItemcounterType2_3.WATER && !this.field6) {
   ...
   public com.moonsworth.lunar.client.render.turbo.PathNode method12(Vector3iBridge var1) {
      com.moonsworth.lunar.client.render.turbo.PathNode var2 = this.method24(var1);
      var2.field8 = this.method24(var2.x, var2.y, var2.z);
      var2.field7 = this.field1.method2(var2.field8);
      return var2;
   }
   ...
   public com.moonsworth.lunar.client.render.turbo.PathNode method14(int var1, int var2, int var3, ItemcounterType2_3 var4, float var5) {
      com.moonsworth.lunar.client.render.turbo.PathNode var6 = this.method3(var1, var2, var3);
      var6.field8 = var4;
      var6.field7 = Math.max(var6.field7, var5);
      return var6;
   }

   public com.moonsworth.lunar.client.render.turbo.PathNode method15(int var1, int var2, int var3) {
      com.moonsworth.lunar.client.render.turbo.PathNode var4 = this.method3(var1, var2, var3);
   ...
   public boolean method16(Vector3iBridge var1) {
      ...
      return var2 != ItemcounterType2_3.OPEN && this.field1.method2(var2) >= 0.0F;
   }

   public double method17() {
      return Math.max(1.125, this.field1.method3());
   }

   public boolean method18(
      com.moonsworth.lunar.client.render.turbo.PathNode var1,
      @Nullable com.moonsworth.lunar.client.render.turbo.PathNode var2,
      @Nullable com.moonsworth.lunar.client.render.turbo.PathNode var3
   ) {
      if (var3 != null
         && var2 != null
         && var3.y <= var1.y
         ...
         boolean var4 = var3.field8 == ItemcounterType2_3.FENCE
            ...
            && this.field1.method7().method14() < 0.5;
   ...
   public boolean method19(@Nullable com.moonsworth.lunar.client.render.turbo.PathNode var1) {
   ...
   public com.moonsworth.lunar.client.render.turbo.PathNode method20(int var1, int var2, int var3, ItemcounterType2_3 var4) {
      com.moonsworth.lunar.client.render.turbo.PathNode var5 = this.method3(var1, var2, var3);
      var5.closed = true;
      var5.field8 = var4;
   ...
   @Nullable
   public com.moonsworth.lunar.client.render.turbo.PathNode method21(
      int var1, int var2, int var3, int var4, double var5, HorsestatsType_2 var7, ItemcounterType2_3 var8, Vector3iBridge.Extension var9
   ) {
      com.moonsworth.lunar.client.render.turbo.PathNode var10 = this.method11(var1, var2 + 1, var3, var4 - 1, var5, var7, var8);
      if (var10 == null) {
         return null;
      }

      if (this.field1.method7().method14() >= 1.0) {
         return var10;
      }
      ...
      double var15 = this.field1.method7().method14() / 2.0;
      var9.method1(var11, var2 + 1, var13);
      double var17 = this.method9(var9) + 0.001;
      var9.bridge$setPos(var10.x, var10.y, var10.z);
      double var19 = this.field1.method7().method15() + this.method9(var9) - 0.002;
      AxisAlignedBBBridge var21 = AxisAlignedBBBridge.method2(var11 - var15, var17, var13 - var15, var11 + var15, var19, var13 + var15);
      return this.method8(var21) ? null : var10;
   }

   @Nullable
   public com.moonsworth.lunar.client.render.turbo.PathNode method22(
      int var1, int var2, int var3, @Nullable com.moonsworth.lunar.client.render.turbo.PathNode var4
   ) {
      var2--;
      ...
      while (var2 > ThreadModuleDump63.method8().bridge$getMinBuildHeight()) {
         ...
         var4 = this.method14(var1, var2, var3, var5, this.field1.method2(var5));
         var2--;
      }
   ...
   public ItemcounterType2_3 method24(int var1, int var2, int var3) {
      ...
      return (ItemcounterType2_3)this.field10
         .computeIfAbsent(
            var4.bridge$asLong(), var4x -> this.method25(this.field8, var1, var2, var3, this.field1)
         );
   }

   public ItemcounterType2_3 method25(
      com.moonsworth.lunar.client.render.turbo.PathWorldView var1,
      int var2,
      int var3,
      int var4,
      com.moonsworth.lunar.client.render.turbo.PathEntity var5
   ) {
   ...
   public Set<ItemcounterType2_3> method26(com.moonsworth.lunar.client.render.turbo.PathWorldView var1, int var2, int var3, int var4) {
      EnumSet var5 = EnumSet.noneOf(ItemcounterType2_3.class);

      for (int var6 = 0; var6 < this.field3; var6++) {
         for (int var7 = 0; var7 < this.field4; var7++) {
            for (int var8 = 0; var8 < this.field5; var8++) {
               int var9 = var6 + var2;
               int var10 = var7 + var3;
               int var11 = var8 + var4;
   ...
   public static ItemcounterType2_3 method28(com.moonsworth.lunar.client.render.turbo.PathWorldView var0, Vector3iBridge.Extension var1) {
   ...
   public static ItemcounterType2_3 method29(
      com.moonsworth.lunar.client.render.turbo.PathWorldView var0, int var1, int var2, int var3, ItemcounterType2_3 var4
   ) {
   ...
   public static ItemcounterType2_3 method30(com.moonsworth.lunar.client.render.turbo.PathWorldView var0, int var1, int var2, int var3) {
