...
public abstract class EventBusV1_12Mixin {
   @Shadow
   public IEventExceptionHandler exceptionHandler;
   @Shadow
   public int busID;

   public EventBusV1_12Mixin() {
   }
   ...
   public void ichor$silenceRegisterLog(Logger logger1, String text2, Object obj3, Object obj4) {
   }
}
