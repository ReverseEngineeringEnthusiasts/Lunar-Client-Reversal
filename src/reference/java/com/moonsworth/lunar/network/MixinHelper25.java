...
public class GameBlogPostInteractionEventData extends MixinHelper2 implements Serializable {
   ...
   private GameBlogPostInteractionEventData.Type interactionType;
   public static HashSet<String> field61 = new HashSet<>();
   public static HashSet<String> field62 = new HashSet<>();

   public GameBlogPostInteractionEventData method2(String var1) {
      this.postId = var1;
      return this;
   }
   ...
   public void setPostId(String var1) {
      this.postId = var1;
   }

   public GameBlogPostInteractionEventData interactionType(GameBlogPostInteractionEventData.Type var1) {
      this.interactionType = var1;
      return this;
   }

   @Nonnull
   public GameBlogPostInteractionEventData.Type getInteractionType() {
      return this.interactionType;
   }

   public void setInteractionType(GameBlogPostInteractionEventData.Type var1) {
      this.interactionType = var1;
   }
   ...
   public boolean equals(Object var1) {
      if (this == var1) {
         ...
         GameBlogPostInteractionEventData var2 = (GameBlogPostInteractionEventData)var1;
         return Objects.equals(this.postId, var2.postId) && Objects.equals(this.interactionType, var2.interactionType) && super.equals(var1);
      } else {
         return false;
      }
   }
   ...
   @Override
   public int hashCode() {
      return Objects.hash(this.postId, this.interactionType, super.hashCode());
   }
   ...
   public String toString() {
      ...
      var1.append("    postId: ").append(this.toIndentedString(this.postId)).append("\n");
   ...
   public static void validateJsonElement(JsonElement var0) {
      if (var0 == null && !field62.isEmpty()) {
         throw new IllegalArgumentException(
            String.format("The required field(s) %s in GameBlogPostInteractionEventData is not found in the empty JSON string", field62.toString())
         );
      }
      ...
      GameBlogPostInteractionEventData.Type.validateJsonElement(var5.get("interaction_type"));
   }

   public static GameBlogPostInteractionEventData method9(String var0) {
      return (GameBlogPostInteractionEventData)com.moonsworth.lunar.network.mixin.MixinHelper7.getGson().fromJson(var0, GameBlogPostInteractionEventData.class);
   }
   ...
   public static class Data implements TypeAdapterFactory {
      public <T> TypeAdapter<T> create(Gson var1, TypeToken<T> var2) {
         if (!GameBlogPostInteractionEventData.class.isAssignableFrom(var2.getRawType())) {
            return null;
         }

         final TypeAdapter var3 = var1.getAdapter(JsonElement.class);
         final TypeAdapter var4 = var1.getDelegateAdapter(this, TypeToken.get(GameBlogPostInteractionEventData.class));
         return (new TypeAdapter<GameBlogPostInteractionEventData>() {
            public void method1(JsonWriter var1, GameBlogPostInteractionEventData var2x) {
               JsonObject var3x = var4.toJsonTree(var2x).getAsJsonObject();
               var3.write(var1, var3x);
            }

            public GameBlogPostInteractionEventData method2(JsonReader var1) {
               JsonElement var2x = (JsonElement)var3.read(var1);
               return (GameBlogPostInteractionEventData)var4.fromJsonTree(var2x);
            }
         }).nullSafe();
      }
   }

   @JsonAdapter(GameBlogPostInteractionEventData.Type.Data.class)
   public enum Type {
      ...
      public static GameBlogPostInteractionEventData.Type fromValue(String var0) {
         for (GameBlogPostInteractionEventData.Type var4 : values()) {
      ...
      public static class Data extends TypeAdapter<GameBlogPostInteractionEventData.Type> {
         public void method1(JsonWriter var1, GameBlogPostInteractionEventData.Type var2) {
            var1.value(var2.getValue());
         }

         public GameBlogPostInteractionEventData.Type method2(JsonReader var1) {
            String var2 = var1.nextString();
            return GameBlogPostInteractionEventData.Type.fromValue(var2);
         }
      }
   }
}
