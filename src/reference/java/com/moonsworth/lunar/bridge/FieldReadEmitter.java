...
public class FieldReadEmitter implements BytecodeEmitter {
   ...
   public FieldReadEmitter(com.moonsworth.lunar.ichor.mixin.MixinHelper3 var1, FieldNode var2, com.moonsworth.lunar.ichor.mixin.MixinHelper3 var3, BytecodeEmitter var4) {
      this.field1 = var1;
      this.field2 = var2;
      this.field3 = var3;
      this.field4 = var4;
   ...
   public void method1(BridgeMethodGenerator var1, Queue<MethodParameter> var2, Stack<com.moonsworth.lunar.ichor.mixin.MixinHelper3> var3, InsnList var4) {
      ...
      var4.add(
         new FieldInsnNode(var5 ? 178 : 180, ((com.moonsworth.lunar.ichor.mixin.MixinHelper7)this.field1.method2()).name(), this.field2.name, this.field2.desc)
      );
      var3.push(this.field3);
   }
