...
public interface EntityRenderStateBridge extends Bridge_61 {
   ...
   @Nullable
   Vec3Bridge bridge$getPassengerOffset(@Nullable BridgeExtension bridgeextension1);
   ...
   default void bridge$extractRenderStates(BridgeExtension bridgeextension1) {
   }

   void bridge$extractRenderStates$Entity(BridgeExtension bridgeextension1);
