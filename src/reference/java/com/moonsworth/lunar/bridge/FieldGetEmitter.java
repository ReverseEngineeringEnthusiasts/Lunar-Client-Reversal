...
public class FieldGetEmitter implements BytecodeEmitter {
   ...
   public FieldGetEmitter(MixinHelper3 mixinhelper31, FieldNode field2_, MixinHelper3 mixinhelper33, BytecodeEmitter bridge_154) {
   ...
   public void method1(BridgeMethodGenerator bridge_671, Queue<MethodParameter> queue, Stack<MixinHelper3> stack3, InsnList instructions4) {
      ...
      instructions4.add(new FieldInsnNode(flag5 ? 178 : 180, ((ClassTypeSignature)this.field1.method2()).name(), this.field2.name, this.field2.desc));
      stack3.push(this.field3);
   }
