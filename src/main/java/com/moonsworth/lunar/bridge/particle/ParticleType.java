...
public enum ParticleType {
   ...
   private static final Map<Integer, ParticleType> ID_MAP = new HashMap<>();
   private static final Map<String, ParticleType> NAME_MAP = new HashMap<>();
   private final String[] resourceLocations;
   private ParticleData dataProvider;

   ParticleType(String... items3) {
      this.resourceLocations = items3;
   }
   ...
   @Nullable
   public static ParticleType getParticleFromId(int index0) {
      return ID_MAP.get(index0);
   }

   @Nullable
   public static ParticleType getParticleFromName(String text) {
   ...
   public static void populateRegistry() {
      ...
      for (ParticleType horsestatstype23 : values()) {
         if (horsestatstype23.isAvailable()) {
            ID_MAP.put(horsestatstype23.getDataProvider().getId(), horsestatstype23);
            NAME_MAP.put(horsestatstype23.getDataProvider().getName(), horsestatstype23);
         }
      }
   }
   ...
   @Generated
   public ParticleData getDataProvider() {
      return this.dataProvider;
   }

   @Generated
   public void setDataProvider(ParticleData horsestats1) {
      this.dataProvider = horsestats1;
   }
}
