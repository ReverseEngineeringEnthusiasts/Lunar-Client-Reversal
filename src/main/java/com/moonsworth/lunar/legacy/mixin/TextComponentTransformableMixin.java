...
public interface TextComponentTransformableMixin extends ComponentTransformable {
   @Nullable
   default <S extends State> TransformableResult renderSelf(
      ...
      return AdventureMixins.renderSelfText((TextComponent)this, componenttransformrenderer1, component2, list3, value4);
   }
}
