...
public enum HologramsType_2 {
   ...
   HologramsType_2(int value, Vector3i vector3i, Vector3i vector3i2, int value2, int value3, Vector2i vector2i, Float floatValue, int value4, int value5) {
      this.dungeonFloor = value;
      this.topLeftBound = vector3i;
      this.bottomRightBound = vector3i2;
      this.widthInWorld = value2;
      this.heightInWorld = value3;
      this.topLeft = vector2i;
