...
public class EventUseItemOnBlockLegacy extends Highlight {
   ...
   @Generated
   public EventUseItemOnBlockLegacy(Vector3i vector3i, int value, int value2, Vector3d vector3d, boolean flag, boolean flag2) {
      this.field1 = vector3i;
      this.field2 = value;
      this.field3 = value2;
      this.field4 = vector3d;
      this.field5 = flag;
      this.field6 = flag2;
   }
}
