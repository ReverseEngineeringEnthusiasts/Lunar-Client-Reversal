...
public class EventSoundPlay extends com.moonsworth.lunar.client.highlight.HighlightImpl {
   ...
   @Generated
   public EventSoundPlay(ResourceLocationBridge var1, String text, boolean flag, float value, float value2, float value3, float value4, float value5) {
      this.field1 = var1;
      this.category = text;
      this.field2 = flag;
      this.volume = value;
