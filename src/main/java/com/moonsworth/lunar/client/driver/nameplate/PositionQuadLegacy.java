...
import com.moonsworth.lunar.client.driver.component.PositionQuad;

public class PositionQuadLegacy {
   ...
   public static PositionQuadLegacy method1() {
      return new PositionQuadLegacy(0.0F, 0.0F, 0.0F, 0.0F);
   }
   ...
   @Generated
   public PositionQuadLegacy(float var1, float value, float value2, float value3) {
      this.field1 = var1;
      this.field2 = value;
      this.field3 = value2;
      this.field4 = value3;
