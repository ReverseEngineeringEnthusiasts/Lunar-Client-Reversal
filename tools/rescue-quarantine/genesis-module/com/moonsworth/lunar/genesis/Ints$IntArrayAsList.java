...
class Ints$IntArrayAsList extends AbstractList<Integer> implements Serializable, RandomAccess {
   ...
   Ints$IntArrayAsList(int[] items1) {
      this(items1, 0, items1.length);
   }

   Ints$IntArrayAsList(int[] items1, int number2, int number3) {
      this.field1 = items1;
      this.field2 = number2;
      this.field3 = number3;
   }
   ...
   public boolean contains(Object obj1) {
      return obj1 instanceof Integer && MixinHelper122.access$000(this.field1, (Integer)obj1, this.field2, this.field3) != -1;
   }

   @Override
   public int indexOf(Object obj1) {
      if (obj1 instanceof Integer) {
         int number2 = MixinHelper122.access$000(this.field1, (Integer)obj1, this.field2, this.field3);
         if (number2 >= 0) {
   ...
   public int lastIndexOf(Object obj1) {
      if (obj1 instanceof Integer) {
         int number2 = MixinHelper122.access$100(this.field1, (Integer)obj1, this.field2, this.field3);
         if (number2 >= 0) {
            return number2 - this.field2;
         }
      }
   ...
   public Integer set(int index1, Integer number2) {
      Preconditions.checkElementIndex(index1, this.size());
      int number3 = this.field1[this.field2 + index1];
      this.field1[this.field2 + index1] = (Integer)Preconditions.checkNotNull(number2);
      return number3;
   }
   ...
   public List<Integer> subList(int number1, int number2) {
      ...
      return number1 == number2 ? Collections.emptyList() : new Ints$IntArrayAsList(this.field1, this.field2 + number1, this.field2 + number2);
   }
   ...
   public boolean equals(@Nullable Object obj1) {
      ...
      if (obj1 instanceof Ints$IntArrayAsList) {
         Ints$IntArrayAsList mixinhelper122$data22 = (Ints$IntArrayAsList)obj1;
         int number3 = this.size();
         if (mixinhelper122$data22.size() != number3) {
            return false;
         }

         for (int index4 = 0; index4 < number3; index4++) {
            if (this.field1[this.field2 + index4] != mixinhelper122$data22.field1[mixinhelper122$data22.field2 + index4]) {
               return false;
            }
         }
   ...
   public int hashCode() {
      ...
      for (int index2 = this.field2; index2 < this.field3; index2++) {
         number1 = 31 * number1 + MixinHelper122.hashCode(this.field1[index2]);
      }
