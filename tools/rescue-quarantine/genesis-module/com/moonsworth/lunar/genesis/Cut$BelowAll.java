...
final class Cut$BelowAll extends SerializableLoader<Comparable<?>> {
   private static final Cut$BelowAll field3 = new Cut$BelowAll();
   ...
   Comparable<?> method5(MixinHelper40<Comparable<?>> mixinhelper401) {
      return mixinhelper401.minValue();
   }
   ...
   SerializableLoader<Comparable<?>> method7(MixinHelper40<Comparable<?>> mixinhelper401) {
      try {
         return SerializableLoader.method11(mixinhelper401.minValue());
