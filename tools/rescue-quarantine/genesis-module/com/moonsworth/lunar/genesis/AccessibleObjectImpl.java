...
class AccessibleObjectImpl extends AccessibleObject implements Member {
   private final AccessibleObject field1;
   private final Member field2;

   <M extends AccessibleObject & Member> AccessibleObjectImpl(M var1) {
      Preconditions.checkNotNull(var1);
      this.field1 = var1;
      this.field2 = (Member)var1;
   }
   ...
   @Override
   public final boolean isAnnotationPresent(Class<? extends java.lang.annotation.Annotation> var1) {
      return this.field1.isAnnotationPresent(var1);
   }

   @Override
   public final <A extends java.lang.annotation.Annotation> A getAnnotation(Class<A> var1) {
      return this.field1.getAnnotation(var1);
   }
   ...
   public final void setAccessible(boolean var1) {
      this.field1.setAccessible(var1);
   }
   ...
   public boolean equals(@Nullable Object var1) {
      if (!(var1 instanceof AccessibleObjectImpl)) {
         return false;
      }

      AccessibleObjectImpl var2 = (AccessibleObjectImpl)var1;
      return this.method1().equals(var2.method1()) && this.field2.equals(var2.field2);
   }
