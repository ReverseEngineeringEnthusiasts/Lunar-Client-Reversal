...
final class Traverser$TreeTraverser<N> extends MixinHelper_14<N> {
   private final PredecessorsFunction<N> field1;

   Traverser$TreeTraverser(PredecessorsFunction<N> mixinhelper6_71) {
      super(null);
   ...
   public Iterable<N> breadthFirst(Iterable<? extends N> list1) {
      ...
      for (Object obj3 : list1) {
         this.checkThatNodeIsInTree((N)obj3);
      }

      return new Data54$1(this, list1);
   }
   ...
   public Iterable<N> depthFirstPreOrder(Iterable<? extends N> list1) {
      ...
      return new Data54$2(this, list1);
   }
   ...
   public Iterable<N> depthFirstPostOrder(Iterable<? extends N> list1) {
      ...
      return new Data54$3(this, list1);
   }

   private void checkThatNodeIsInTree(N value1) {
