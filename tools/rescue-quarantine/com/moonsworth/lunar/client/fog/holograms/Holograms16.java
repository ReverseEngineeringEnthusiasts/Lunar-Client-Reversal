...
import com.moonsworth.lunar.bridge.BridgeType_3;
...
import com.moonsworth.lunar.bridge.horsestats.HorsestatsHandler;
...
import com.moonsworth.lunar.client.click.chest.ChestType;
import com.moonsworth.lunar.client.fog.FogHandler;
import com.moonsworth.lunar.client.fog.holograms.click.Click;
import com.moonsworth.lunar.client.fog.holograms.click.ClickHandler;
import com.moonsworth.lunar.client.fog.holograms.click.ClickHandler2;
import com.moonsworth.lunar.client.fog.holograms.click.Gui2Handler;
import com.moonsworth.lunar.client.fov.Fov11;
import com.moonsworth.lunar.client.highlight.Highlight3;
import com.moonsworth.lunar.client.highlight.HighlightImpl7;
...
import com.moonsworth.lunar.client.highlight.mixin.fishing.HighlightImpl4;
import com.moonsworth.lunar.client.highlight.mixin.rewindhandlers.HighlightImpl6;
import com.moonsworth.lunar.client.markers.mixin.gui.GuiIterator;
import com.moonsworth.lunar.client.mod.misc.Rewind;
import com.moonsworth.lunar.client.util.ThreadModuleDump63;
import com.moonsworth.lunar.client.util.ThreadModuleDump66;
import com.moonsworth.lunar.client.util.ThreadModuleDump9;
...
public class Holograms16 extends FogHandler<Gui2Handler> implements GuiIterator.Extension, Highlight3 {
   private static final Horsestats14 field2 = Horsestats14.create("lunar", "sprays.json");
   private static final Horsestats14[] field3 = new Horsestats14[]{
      Horsestats14.create("lunar", "sound/spray/spraySound1.ogg"),
      Horsestats14.create("lunar", "sound/spray/spraySound2.ogg"),
      Horsestats14.create("lunar", "sound/spray/spraySound3.ogg"),
      Horsestats14.create("lunar", "sound/spray/spraySound4.ogg")
   };
   ...
   private final Int2ObjectMap<Gui2Handler> field8 = new Int2ObjectOpenHashMap();
   private final Object2LongMap<Gui2Handler> field9 = new Object2LongOpenHashMap();
   private final Set<EquippedSpray> field10 = new LinkedHashSet<>();
   private final Map<UUID, LinkedList<ClickHandler2>> field11 = new HashMap<>();
   @Nullable
   private List<Integer> field12 = null;
   private final List<Gui2Handler> field13 = new ArrayList<>();
   private int field14 = 1;
   private long field15;
   @Nullable
   private ClickHandler field16;

   public Holograms16() {
      this.handle(HighlightImpl2.class, this::method9);
      this.handle(HighlightImpl4.class, this::method10);
      this.handle(com.moonsworth.lunar.client.highlight.mixin.nameplate.HighlightImpl2.class, this::method11);
      this.handle(HighlightImpl6.class, var1 -> {
         if (this.field16 != null) {
            this.field16.method8(this.field16.method6() + (var1.method1() < 0.0 ? -2.0F : 2.0F));
            var1.setCancelled(true);
         }
      });
      this.handle(HighlightImpl15.class, var1 -> this.field11.remove(var1.method1().bridge$getUniqueID()));
      this.handle(HighlightImpl7.class, var1 -> this.field16 = null);
      this.method8();
   }
   ...
   public void method2(UUID var1, @NotNull ClickHandler2 var2, int var3, boolean var4) {
      ...
      if (var1 - this.field15 > 900L) {
         ...
         if (var3 != null) {
            ...
            if (var4 != null && !var4.isEmpty()) {
               ...
               ((HorsestatsHandler4)SExtension.method9(SImpl.field12)
                     .method8(var3, var3.bridge$blockInteractionRange(), var5)
                     .method14((var0, var1x) -> true)
                     .method18()
                     .method8(var4))
                  .ORCHOHHCOHCORRICRIHCHHRORHHCHH(
                     var2 -> {
                        Click var3x = (Click)var2.method7();
                        if (var3x instanceof ClickHandler2 var4x) {
                           var4.remove(var4x);
                           ThreadModuleDump63.method5()
                              .ifPresent(
   ...
   public Gui2Handler method5(int var1) {
      return (Gui2Handler)this.field8.get(var1);
   }

   public void method6(Gui2Handler var1, Vector3f var2, HorsestatsType_2 var3, Bridge5Extension_5 var4, boolean var5) {
   ...
   @Nullable
   public ClickHandler method7() {
      ClickHandler var1 = this.field16;
      this.field16 = null;
      return var1;
   }
   ...
   public void method8() {
      if (!this.field8.isEmpty() && ThreadModuleDump63.method3() != null) {
         ...
         while (var2.hasNext()) {
            Gui2Handler var3 = (Gui2Handler)var2.next();
            ...
            this.field8
               .put(
                  ...
                  new Gui2Handler(
                     ...
                     Horsestats14.create(var4.get("resource").getAsString()),
                     Integer.decode("#" + (var4.has("particleColor") ? var4.get("particleColor").getAsString() : null)),
                     ThreadModuleDump9.method6(var4, "width", 1.0F),
                     ThreadModuleDump9.method6(var4, "height", 1.0F),
                     ThreadModuleDump9.method6(var4, "offsetX", 0.0F),
                     ThreadModuleDump9.method6(var4, "offsetY", 0.0F),
                     ThreadModuleDump9.method1(var4, "glowing", false),
                     ThreadModuleDump9.method1(var4, "animated", false),
                     ThreadModuleDump9.method1(var4, "canCover", false),
                     ThreadModuleDump9.method4(var4, "duration", -1)
                  )
               );
         }
      } catch (Exception var6) {
         Slayer.method7("Failed to register sprays from json file", new Object[0]);
   ...
   private void method9(HighlightImpl2 var1) {
      if (!this.field11.isEmpty()) {
         ...
         while (var2.hasNext()) {
            ...
            var3.removeIf(var0 -> var0.method6() <= HighlightImpl2.field1);
            if (var3.isEmpty()) {
               var2.remove();
            }
         }
   ...
   private void method10(HighlightImpl4 var1) {
      if (!this.field11.isEmpty()) {
   ...
   private void method11(com.moonsworth.lunar.client.highlight.mixin.nameplate.HighlightImpl2 var1) {
      BridgeExtension_9 var2 = var1.method3();
      boolean var3 = !this.field11.isEmpty();
      if (var3) {
         for (LinkedList var5 : this.field11.values()) {
            for (ClickHandler2 var7 : var5) {
   ...
   private void method12(BridgeExtension_9 var1, Click var2, int var3) {
      var1.push();
   ...
   private void method13(BridgeExtension_9 var1, Gui2Handler var2, int var3, int var4) {
      Holograms12 var5 = ThreadModuleDump63.method4().method53();
      ...
      if (!var6.isEmpty()) {
         ...
         Bridge2_32 var16 = var1.method10(MixinHelper5_6.field59.get(var2.method4()));
         var16.method1();
         ...
         var16.method17(BridgeType_17.IMMEDIATE);
         if (var2.method8()) {
            Optional var13 = Fov11.method2(var2.method4());
            if (var13.isPresent()) {
               int var14 = Bridge.method8().method92();
               var16 = var1.method10(MixinHelper5_6.field59.get((Horsestats14)var13.get()));
               var16.method1();
   ...
   @Nullable
   public ClickHandler2 method14(Gui2Handler var1, Vector3f var2, HorsestatsType_2 var3, float var4) {
      return this.method15(var1, var2, var3, var4, true);
   }

   @Nullable
   public ClickHandler2 method15(Gui2Handler var1, Vector3f var2, HorsestatsType_2 var3, float var4, boolean var5) {
      ...
      if (var5) {
         ...
         ThreadModuleDump63.method3()
            ...
            .bridge$play(field3[var10], BridgeType2_7.PLAYERS, 1.0F, 1.0F, false, 0, BridgeType_3.NONE, var2.x(), var2.y(), var2.z());
      }

      int var11 = var1.getDuration() != -1 ? var1.getDuration() : 600;
      return new ClickHandler2(var1, HighlightImpl2.field1 + var11, var2, var3, var4 % 360.0F, (Horsestats20Extension2[])var8.value(), var7);
   }

   public void method16(boolean var1, boolean var2, Holograms16.Extension var3, float var4) {
      if (!var2) {
      ...
      ((HorsestatsHandler)SExtension.method9(SImpl.field3)
            ...
            .method8(var6))
         .method7(var6x -> {
            Horsestats15 var7x = var6x.IHCORIOIOOHRCOOIOHIHHCOCIHRRHC();
            ...
            if (var1) {
               ThreadModuleDump63.method4().method69().method7(ChestType.WARNING, "Failed to create spray");
            }
         });
   }

   public int method17(Gui2Handler var1, Matrix4f var2, HorsestatsType_2 var3) {
      if (this.field11.isEmpty()) {
         return 1;
      }
      ...
      Holograms16.Data var6 = new Holograms16.Data(var2, var4, var5, var1.method6(), var1.method7());
      int var7 = 0;

      for (List var9 : this.field11.values()) {
         for (ClickHandler2 var11 : var9) {
            if (var11.method3() == var3 && var11.method5() >= var7) {
               Gui2Handler var12 = var11.method1();
               Holograms16.Data var13 = new Holograms16.Data(
   ...
   @Override
   protected Set<Gui2Handler> method3() {
      return new HashSet<>();
   }

   public void method19(Object2LongMap<Gui2Handler> var1) {
      this.field9.clear();
   ...
   public void method21() {
      ...
      Holograms12 var3 = ThreadModuleDump63.method4().method53();
      ObjectIterator var4 = var1.iterator();

      while (var4.hasNext()) {
         Gui2Handler var5 = (Gui2Handler)var4.next();
   ...
   public void method22() {
      ...
      for (EquippedSpray var4 : this.method42()) {
         Gui2Handler var5 = this.method5(var4.getSprayId());
         if (var5 != null) {
            JsonObject var6 = var5.provide().getAsJsonObject();
      ...
      for (Gui2Handler var9 : this.field13) {
   ...
   public static Vector3f method25(boolean var0, Vector3f var1, HorsestatsType_2 var2) {
      if (var0) {
         Type var4 = var2.getAxis();
         return var1.set(
            var4 != Type.X ? Math.floor(var1.x() + 0.5F) : var1.x(),
            var4 != Type.Y ? Math.floor(var1.y() + 0.5F) : var1.y(),
            var4 != Type.Z ? Math.floor(var1.z() + 0.5F) : var1.z()
         );
      }

      if (ThreadModuleDump63.method4().method41().method8().method40()) {
         Type var3 = var2.getAxis();
         if (var3 != Type.X) {
   ...
   public static Vector3f method26(boolean var0, Horsestats15 var1, HorsestatsType_2 var2) {
      boolean var3 = var2.getDirection() == Type2.NEGATIVE;
   ...
   @Nullable
   public static BooleanObjectPair<Horsestats20Extension2[]> method27(Gui2Handler var0, Matrix4f var1, HorsestatsType_2 var2, boolean var3) {
      ...
      Holograms16.Data var7 = new Holograms16.Data(var1, var5, var6, var0.method6(), var0.method7());
   ...
   private static boolean method33(Holograms16.Data var0, Vector3f var1, Vector3f var2) {
   ...
   private static boolean method34(Holograms16.Data var0, Holograms16.Data var1) {
   ...
   private static boolean method35(Holograms16.Data var0, Vector3f var1, Vector3f[] var2, Vector3f var3) {
   ...
   public void method37(List<Integer> var1) {
      ...
      for (Integer var3 : var1) {
         Gui2Handler var4 = this.method5(var3);
         if (var4 == null) {
            Slayer.method5("Could not find free lunar+ spray: %d", new Object[]{var3});
         } else {
   ...
   @Generated
   public Int2ObjectMap<Gui2Handler> method40() {
      return this.field8;
   }

   @Generated
   public Object2LongMap<Gui2Handler> method41() {
      return this.field9;
   }
   ...
   @Generated
   public Map<UUID, LinkedList<ClickHandler2>> method43() {
      return this.field11;
   }
   ...
   @Generated
   public List<Gui2Handler> method45() {
      return this.field13;
   }
