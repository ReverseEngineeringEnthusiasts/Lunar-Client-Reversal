...
public class SkyblockDungeonRoomNotifications extends Framework7Extension2 {
   private static final String field8 = "DUNGEON_ROOM_CLEARED";
   private static final String field9 = "DUNGEON_ROOM_SECRETS";
   private final GuiRewindhandlersHandler26 field10 = (GuiRewindhandlersHandler26)this.IHRHHRIHICHOOICIRIOOHOICHIRHOI(GuiRewindhandlersHandler26.class);
   private final GuiRewindhandlersHandler2_2 field11 = (GuiRewindhandlersHandler2_2)this.IHRHHRIHICHOOICIRIOOHOICHIRHOI(GuiRewindhandlersHandler2_2.class);
   private final LightingExtension443 field12 = (LightingExtension443)((Data)LightingExtension443.method10("dungeonRoomClearedAlert")
         .OOOIROIIOCOOHICRIRHHHRROHHHHIO(true))
      .method2(0.5F)
      .RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   private final LightingExtension443 field13 = (LightingExtension443)((Data)LightingExtension443.method10("dungeonSecretsDoneAlert")
         .OOOIROIIOCOOHICRIRHHHRROHHHHIO(true))
      .method2(0.5F)
      .RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   ...
   private SkyblockDungeonScoreAlert method13() {
      return (SkyblockDungeonScoreAlert)((Framework4)this.RHRHIOOCICIORIOCIHHCIIRCRHHOII(Framework.field16)).method1();
   }

   public void method2(com.moonsworth.lunar.client.lighting.LightingExtension23.Data var1) {
   ...
   private void method4(HighlightImpl2 var1) {
      Holograms2_5 var2 = (Holograms2_5)this.field11.method5().orElse(null);
      if (var2 != null) {
   ...
   private boolean method9(Holograms4Iterator var1) {
      if ((Boolean)this.field13.get() && this.method7(var1)) {
