...
public class SkyblockVitalityHud extends Framework7Extension2 {
   private final LightingExtension443 field17 = (LightingExtension443)Lighting.method7("alwaysShow").RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   ...
   protected Data method13() {
      return new Data(0, 100, Gui2Extension2.MIDDLE_CENTER);
   }

   protected List<com.moonsworth.lunar.client.framework.feature.mod.gui.nameplate.Nameplate3.Data> method14() {
      return !this.field17.get() && !this.IHOIIICRHRORRCORICRIHRRRHHRIOC.method16()
         ? List.of()
         : this.method5(this.IHOIIICRHRORRCORICRIHRRRHHRIOC.method17(), this.IHOIIICRHRORRCORICRIHRRRHHRIOC.method18());
   }

   protected List<com.moonsworth.lunar.client.framework.feature.mod.gui.nameplate.Nameplate3.Data> method15() {
      return this.method5(24, 139);
   }
   ...
   private List<com.moonsworth.lunar.client.framework.feature.mod.gui.nameplate.Nameplate3.Data> method5(int var1, int var2) {
      ...
      var3.add(new com.moonsworth.lunar.client.framework.feature.mod.gui.nameplate.Nameplate3.Data(var1, var2, NamedTextColor.DARK_RED.value(), '♨'));
      return var3;
   }
}
