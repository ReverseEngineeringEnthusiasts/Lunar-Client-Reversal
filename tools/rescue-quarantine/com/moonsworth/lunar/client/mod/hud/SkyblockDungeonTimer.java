...
import com.moonsworth.lunar.client.fog.holograms.Gui2Extension;
...
import com.moonsworth.lunar.client.framework.MixinCore2;
import com.moonsworth.lunar.client.framework.MixinCore8;
...
import com.moonsworth.lunar.client.lighting.LightingExtension422;
...
public class SkyblockDungeonTimer extends Framework7Extension2 {
   ...
   private final GuiRewindhandlersHandler2 field9 = (GuiRewindhandlersHandler2)this.IHRHHRIHICHOOICIRIOOHOICHIRHOI(GuiRewindhandlersHandler2.class);
   ...
   private final LightingExtension443 field13 = (LightingExtension443)((Data2)Lighting.method7("dungeonTimer").OOOIROIIOCOOHICRIRHHHRROHHHHIO(true))
      .RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   private final LightingExtension443 field14 = (LightingExtension443)((Data2)Lighting.method7("kuudraTimer").OOOIROIIOCOOHICRIRHHHRROHHHHIO(true))
      .RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   private final LightingExtension422 field15 = (LightingExtension422)((com.moonsworth.lunar.client.lighting.LightingExtension422.Data)((com.moonsworth.lunar.client.lighting.LightingExtension422.Data)Lighting.method4(
               "dungeonTimerDecimals"
            )
            .ORCRHOICOIHCRRIOHIHIROHOCRRIOO(2))
         .OCRRICRIORICCCRHIOHORCICIHHICO(0, 3))
      .RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   private final LightingExtension443 field16 = (LightingExtension443)((Data2)Lighting.method7("dungeonTimerInChat").OOOIROIIOCOOHICRIRHHHRROHHHHIO(true))
      .RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   private final LightingExtension443 field17 = (LightingExtension443)Lighting.method7("dungeonTimerShowDifference").RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   private final LightingExtension443 field18 = (LightingExtension443)((Data2)Lighting.method7("skyblockShowSplitTickTime")
         .OOOIROIIOCOOHICRIRHHHRROHHHHIO(true))
      .RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   private final LightingExtension497<Gui2Extension> field19 = (LightingExtension497<Gui2Extension>)Lighting.method10(
         "dungeonTimerCurrentPaceColor", Gui2Extension.GOLD
      )
      .RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   private final LightingExtension497<Gui2Extension> field20 = (LightingExtension497<Gui2Extension>)Lighting.method10(
         "dungeonTimerSumOfBestColor", Gui2Extension.GOLD
      )
      .RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   private final LightingExtension497<Gui2Extension> field21 = (LightingExtension497<Gui2Extension>)Lighting.method10("dungeonTimerColor", Gui2Extension.GRAY)
      .RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   private final LightingExtension497<Gui2Extension> field22 = (LightingExtension497<Gui2Extension>)Lighting.method10(
         "dungeonTimerBeatPBColor", Gui2Extension.GREEN
      )
      .RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   private final LightingExtension497<Gui2Extension> field23 = (LightingExtension497<Gui2Extension>)Lighting.method10(
         "dungeonTimerDidNotBeatPBColor", Gui2Extension.RED
      )
      .RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   private final LightingExtension497<Gui2Extension> field24 = (LightingExtension497<Gui2Extension>)Lighting.method10(
         "dungeonTimerBeatGoldColor", Gui2Extension.GOLD
      )
      .RIRRHIRCCHCCHOICRHRHHRIHOIHHRH();
   ...
   public SkyblockDungeonTimer(Skyblock var1) {
      ...
      this.method32(Framework.field17, Framework2.method2(RewindhandlersType.TIMERS));
      this.method32(Framework.field19, Framework11.method1(this, Click3::method1));
      ...
      this.handle(com.moonsworth.lunar.client.framework.feature.mod.rewindhandlers.HighlightBase5.Data2.class, this::method2);
   ...
   private void method2(com.moonsworth.lunar.client.framework.feature.mod.rewindhandlers.HighlightBase5.Data2 var1) {
   ...
   private void method3(com.moonsworth.lunar.client.highlight.mixin.HighlightImpl.Data var1) {
      if (this.field26 != null) {
         String var2 = HorsestatsType8.getTextWithoutFormattingCodes(var1.OROIIOCCOORRCRCIIHHOCCCRHICRCC());
   ...
   private void method13() {
      ...
      if ((Boolean)this.field16.get() && this.field27 != this.field26.size() - 1) {
      ...
      var1.HORHROIOIOICIRHIOCOICHHHIHCIIO(
         ...
         var1x -> var1x.ICRHORIIHOHROHOHOCOOHOOCOORRHO(
            new Lighting_7[]{
               ...
               this.field24,
               this.field18,
               Lighting.method14("skyblockSplitsResetPBs").method4(() -> {
   ...
   @Generated
   public LightingExtension443 method23() {
      return this.field13;
   }

   @Generated
   public LightingExtension443 method24() {
      return this.field14;
   }

   @Generated
   public LightingExtension422 method25() {
      return this.field15;
   }

   @Generated
   public LightingExtension443 method26() {
      return this.field16;
   }

   @Generated
   public LightingExtension443 method27() {
      return this.field17;
   }
   ...
   @Generated
   public LightingExtension497<Gui2Extension> method29() {
      return this.field19;
   }

   @Generated
   public LightingExtension497<Gui2Extension> method30() {
      return this.field20;
   }

   @Generated
   public LightingExtension497<Gui2Extension> method34() {
      return this.field21;
   }

   @Generated
   public LightingExtension497<Gui2Extension> method35() {
      return this.field22;
   }

   @Generated
   public LightingExtension497<Gui2Extension> method36() {
      return this.field23;
   }

   @Generated
   public LightingExtension497<Gui2Extension> method37() {
      return this.field24;
   }
   ...
   private class Data extends MixinCore8<List<TextComponent>> {
      private static final double field31 = 6.4;
      private List<Holograms4_4> field32;

      public Data() {
         super(0.0F, 0.0F, Gui2Extension2.TOP_LEFT, true);
      }
      ...
      private List<TextComponent> method3(List<Holograms4_4> var1) {
         ...
         if (SkyblockDungeonTimer.this.field19.get() != Gui2Extension.OFF) {
         ...
         if (SkyblockDungeonTimer.this.field20.get() != Gui2Extension.OFF) {
      ...
      protected com.moonsworth.lunar.client.hitbox.Gui2Extension method16() {
         return com.moonsworth.lunar.client.hitbox.Gui2Extension.LEFT;
      }
      ...
      private TextComponent method9(List<Holograms4_4> var1) {
         ...
         return (TextComponent)((TextComponent)((TextComponent)((TextComponent)Component.empty().style(Click12.method1(SkyblockDungeonTimer.this.field19)))
                  .append(Component.text(SkyblockDungeonTimer.this.method33("currentPace", new Object[0]))))
               .append(Component.text(": ")))
            .append(Component.text(ThreadModuleDump11.method1((long)var2 * 1000L)));
      }
      ...
      private TextComponent method10(List<Holograms4_4> var1) {
         ...
         return (TextComponent)((TextComponent)((TextComponent)((TextComponent)Component.empty().style(Click12.method1(SkyblockDungeonTimer.this.field20)))
