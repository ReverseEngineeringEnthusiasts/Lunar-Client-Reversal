...
import com.moonsworth.lunar.client.highlight.mixin.HighlightType2;
...
public class Nameplate2Impl extends Nameplate2 {
   ...
   public void method1(ByteBufLoader var1) {
      ...
      this.field3 = var1.method9(HighlightType2.class);
   }
   ...
   public void method3(Nameplate4 var1) {
      ...
      if (var3 != null) {
         ...
         if (ThreadModuleDump63.MC_VERSION <= 5) {
            var8 = BridgeExtension_9.method32();
         } else {
            Data var9 = BridgeExtension2_11.method50();
         ...
         if (var12) {
            try {
               var3.bridge$drawScreen((BridgeExtension_9)var8, var6, var7, var4);
   ...
   @Generated
   public Nameplate2Impl(char var1, int var2, int var3, boolean var4, boolean var5, HighlightType2 var6) {
      this.character = var1;
      this.keyCode = var2;
      this.modifiers = var3;
      this.field1 = var4;
