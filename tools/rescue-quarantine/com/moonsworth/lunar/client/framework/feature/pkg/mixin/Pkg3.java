...
import com.moonsworth.lunar.bridge.MixinHelper6_3;
...
public class Pkg3 {
   @Annotation2(max = 5)
   public static MixinHelper6_3 field1;
   public float x;
   public float y;
   public float z;
   public float xRot;
   ...
   @Annotation2(max = 5)
   public void method6(BridgeExtension3_5 var1, float var2, Horsestats14 var3) {
      this.method7(var1, var2, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, var3);
   }

   @Annotation2(max = 5)
   public void method7(BridgeExtension3_5 var1, float var2, float var3, float var4, float var5, float var6, float var7, Horsestats14 var8) {
      if (this.visible) {
         if (!this.field2.isEmpty()) {
            var1.push();
            ...
            boolean var9 = Bridge.method5().map(Slayer2::getConfig).<Boolean>map(Slayer4::hasShaders).orElse(false);
            ...
            Bridge20 var10 = field1.get(var8);
   ...
   private void method8(BridgeExtension3_5 var1) {
      Bridge_63 var2;
      if (this.field3) {
         var2 = ((Slayer2)Bridge.method5().get()).getShaders().getEntityModelVertexFormat();
      } else {
         var2 = Bridge_27.field5;
      }

      Bridge2_32 var3 = var1.method10((Bridge20)MixinHelper5_6.field64.apply(var2));
      var3.method1();
      ...
      var3.method17(BridgeType_17.BATCHED);
   }
   ...
   static {
      if (ThreadModuleDump63.MC_VERSION <= 5) {
         Bridge_45 var0 = Bridge.method8()
            ...
            .method7("none")
            .method4("none")
            .method11(Bridge_27.field5, BridgeType_6.QUADS)
            .method32(Bridge2_15.field13)
            .method44();
         field1 = MixinHelper5_6.method3(
            var1 -> Bridge.method8().method81().method8(Data7.method1(var1)).method12(true).method14(var0, "lunar_3d_skins", 4096, false, false, true)
         );
      }
   }
}
