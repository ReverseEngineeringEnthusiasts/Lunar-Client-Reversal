...
public class HighlightImpl4 extends Highlight {
   ...
   public static void method1(BridgeExtension_9 var0, Bridge2_19 var1, float var2) {
      Highlight2.method29().method12(HighlightImpl4.class, () -> new HighlightImpl4(var0, var1, var2));
   }
   ...
   @Generated
   public HighlightImpl4(BridgeExtension_9 var1, Bridge2_19 var2, float var3) {
      this.field1 = var1;
      this.field2 = var2;
      this.field3 = var3;
   }
